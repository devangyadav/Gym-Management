...
Imports System.IO
Public Class cardiostrengthtrainerfrm
    ...
    Private Sub Allmembersfrm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub loaddata()
        ...
        Try
            ...
            Dim ttype As String = "Cardio and Strength"
            cmd = New SqlCommand("SELECT Profile,Name,ID FROM Trainersmst with (nolock)  WHERE Name LIKE '%" & Mainfrm.btnsearch.Text & "%' and  Trainer_status='" & stat & "' and Trainertype='" & ttype & "' order by ID", con)
