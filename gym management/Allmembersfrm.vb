...
Public Class Allmembersfrm
    ...
    Sub loaddata()
        ...
        Try
            con.Open()
            allmemberpanel.AutoScroll = True
            allmemberpanel.Controls.Clear()
            ...
            While dr.Read
                ...
                allmemberpanel.Controls.Add(pan)
    ...
    Public Sub pic_click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            While dr.Read
                ...
                AddProfile.txtcategory.Text = "Member"
                ...
                AddProfile.txtsubexdate.Text = dr.Item("expiredate")
