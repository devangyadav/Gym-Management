...
Imports System.IO
Public Class cardioandstrengthfrm
    ...
    Private Sub cardioandstrengthfrm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub loaddata()
        Try
            ...
            Dim pln As String = "Cardio and Strength"
            cmd = New SqlCommand("SELECT Profile,Name,ID FROM membersmst  with (nolock)  WHERE Name LIKE '%" & Mainfrm.btnsearch.Text & "%' and  Status='" & stat & "' and Plans='" & pln & "' order by ID", con)
